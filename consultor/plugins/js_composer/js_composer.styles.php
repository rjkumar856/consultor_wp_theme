...
if ( !function_exists( 'consultor_vc_get_css' ) ) {
	add_filter( 'consultor_filter_get_css', 'consultor_vc_get_css', 10, 4 );
	function consultor_vc_get_css($css, $colors, $fonts, $scheme='') {

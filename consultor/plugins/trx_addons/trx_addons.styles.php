...
if (!function_exists('consultor_trx_addons_get_css')) {
	add_filter('consultor_filter_get_css', 'consultor_trx_addons_get_css', 10, 4);
	function consultor_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.slider_outer_controls_side .slider_controls_wrap > a {
	color: {$colors['text_link']};
	background-color: {$colors['alter_link2_05']};
	border-color: {$colors['text_dark']};
}
...
.body_wrap > .side_socials a:hover {
    color: {$colors['inverse_link']};
    background-color: {$colors['text_hover']};
}
...
.widget_contacts .contacts_info  a:hover span.contact_label {
...
.color_style_link2 .sc_item_subtitle:before {
	background-color:{$colors['text_link2']};
}
.color_style_link3 .sc_item_subtitle:before {
...
.scheme_self.footer_wrap .socials_wrap .social_item:hover {
	color: {$colors['inverse_link']} !important;
}
...
.sc_team .sc_team_item_thumb .sc_team_item_socials .social_item:hover {
	color: {$colors['inverse_link']} !important;
}
...
.sc_team_short .sc_team_item:hover .sc_team_item_thumb {
	border-color: {$colors['text_link2']};
}

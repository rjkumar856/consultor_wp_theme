...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Consultor'.
Please install and activate it before starting to use the theme Consultor.
...
Theme documentation is available on http://consultor.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Consultor is Fontello.

...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	if (CONSULTOR_STORAGE['button_hover'] && CONSULTOR_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.consultor_tabs .consultor_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+CONSULTOR_STORAGE['button_hover']);
		if (CONSULTOR_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.consultor_tabs .consultor_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.widget_categories ul > li\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+CONSULTOR_STORAGE['button_hover']);

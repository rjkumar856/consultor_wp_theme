...
if (!function_exists('consultor_customizer_get_css')) {

	function consultor_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = consultor_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('consultor_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];

			
			// Border radius
			//--------------------------------------
			$rad = consultor_get_border_radius();
			$rad50 = ' '.$rad != ' 0' ? '50%' : 0;
			$css['fonts'] .= <<<CSS
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(consultor_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = consultor_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = consultor_customizer_add_theme_colors($colors);
...
.sc_layouts_row_type_narrow .sc_layouts_item a:hover:after,
...
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item a:hover:after,
...
.scheme_self.sc_layouts_row_type_compact .socials_wrap .social_item  {
	color: {$colors['text_link2']} !important;
}
...
.sc_layouts_row_type_compact .socials_wrap .social_item:hover,
.scheme_self.sc_layouts_row_type_compact .socials_wrap .social_item:hover {
	color: {$colors['inverse_link']} !important;
}
...
.sc_layouts_row_type_normal .sc_layouts_item a:hover:after,
...
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item a:hover:after,
...
.top_panel_default .post_meta_item:before, .top_panel_default .post_meta_item a:before {
	color: {$colors['bg_color']};
}
...
.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item.post_categories,
.top_panel_default .top_panel_title .sc_layouts_title .post_counters_comments .post_counters_label,
.top_panel_default .top_panel_title .sc_layouts_title .post_counters_views,
.top_panel_default .top_panel_title .sc_layouts_title .post_counters_likes {
	color: {$colors['bg_color']} !important;
}
...
.top_panel_default .top_panel_title .sc_layouts_title .post_counters_comments:hover .post_counters_label,
.top_panel_default .top_panel_title .sc_layouts_title .post_counters_views:hover span,
.top_panel_default .top_panel_title .sc_layouts_title .post_counters_likes:hover span {
	color: {$colors['text_link']} !important;
}

.top_panel_default .top_panel_title .sc_layouts_title .post_meta_item.post_categories a:hover {
    color: {$colors['inverse_link']} !important;
}
...
.consultor_tabs .consultor_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.consultor_tabs .consultor_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.post_counters_comments:hover .post_counters_number {
    color: {$colors['inverse_link']} !important;
}
...
.post_counters_comments .post_counters_label:hover,
.post_header.entry-header .author_link:hover,
.post_counters_comments:hover,
.post_counters_views:hover,
.post_counters_likes:hover {
	color: {$colors['text_hover2']} !important;
}
...
.post_item_single .post_content .post_meta .post_share .social_item {
    color: {$colors['text_link2']} !important;
}
...
.post_item_single .post_content .post_meta .post_share .social_item:hover {
	color: {$colors['inverse_link']} !important;
}
...
.widget_area .post_item .post_info .post_counters_item:hover .post_counters_label,
aside .post_item .post_info .post_counters_item:hover .post_counters_label {
	color: {$colors['text_hover2']};
}
.comment-author-link.cwp-author-link, .cwp-comment-title {
	color: {$colors['alter_link3']};
}
...
footer.scheme_self .post_counters_comments .post_counters_number,
footer.scheme_self .post_info_item .post_counters_comments,
footer.scheme_self .post_info_item .post_counters_comments .post_counters_label {
    background-color: transparent !important;
    color: {$colors['text_link_07']} !important;
}
footer.scheme_self .post_info_item .post_counters_comments:hover .post_counters_number,
footer.scheme_self .post_info_item .post_counters_comments:hover,
footer.scheme_self .post_info_item .post_counters_comments:hover .post_counters_label {
    background-color: transparent !important;
    color: {$colors['text_link']} !important;
}
...
footer.scheme_self .sc_layouts_item {
    color: {$colors['extra_text']} !important;
}
...
footer.scheme_self .copyright a {
	color: {$colors['text_link']} !important;
}
footer.scheme_self .copyright a:hover {
	color: {$colors['text_dark']} !important;
}
...
CSS;
					...
					$rez = apply_filters('consultor_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'consultor_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>
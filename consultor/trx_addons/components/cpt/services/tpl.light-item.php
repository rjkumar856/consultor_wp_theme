...
?>>
		...
		if ( has_post_thumbnail() && $args['featured']=='image') {
			trx_addons_get_template_part('templates/tpl.featured.php',
											...
											apply_filters('trx_addons_filter_args_featured', array(
															...
															'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size($args['columns'] > 2 ? 'light' : 'big'), 'services-light'),
	...
	<div class="sc_services_item_info">
		...
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			...
			<div class="btn_block">
				<?php if (!empty($meta['order_now'])) { ?>
					<div class="sc_services_item_button sc_item_button order_btn"><a href="<?php echo esc_html($meta['order_now']); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button', 'sc_services', $args)); ?>"><?php esc_html_e('Order now', 'consultor'); ?></a></div>
				<?php } ?>
				<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_services', $args)); ?>"><?php esc_html_e('Learn more', 'consultor'); ?></a></div>
			</div>
		<?php } ?>
	</div>
</div>

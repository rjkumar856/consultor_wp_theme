...
?><article 
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'thumb_size' => trx_addons_get_thumb_size($number<=$featured ? 'bmed' : 'bsmall')
												), 'recent_news-magazine')
								);
    ?><div class="blogger_content"><?php
	...
	// Display content and footer only in the featured posts
		...
		<div class="post_footer entry-footer">
			...
			if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
				?><div class="post_meta"><span class="post_author"><?php echo esc_html__( 'by ', 'consultor' ); ?><?php the_author_link(); ?></span><?php
